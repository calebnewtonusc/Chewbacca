# Chewbacca: full reference

The long version. The short one is the [README](../README.md).
...
| **Skills and plugins**  | 75 skills (19 shipped here, 3 cloned from upstream, 53 from 1 skill pack) plus 19 plugins across 4 marketplaces         |
...
| bigquery-data-analytics, clay, expo, pinecone, playwright, pyright-lsp, railway, serena, typescript-lsp, vercel | Plugin | Language servers, browser automation, deploys, and data tooling                                |
