 ...
 * them nowhere else to put it: "Sid Chowdhury A2F USC IYA", "Diego Delgado Muir
 * Hs CC Prez", "Shirley Park USC BTG". The label is real information and the
 ...
 * an empty string and "Christian Stiker IYA" lost his first name. Here that
...
function isLabelToken(raw, index, corpus) {
  ...
  // IYA" into a person with no name and "Christian Stiker IYA" into a man with
  ...
  // position is what breaks on a three-part name: "Colin Inkyu Kim", "Omor
  // Sunny Chowdhury", "Alyssa Noelle Garcia" all put the surname at index 2,
  ...
  // tail, so "Sid Chowdhury A2F USC IYA" still splits on A2F.
  ...
  // An acronym at position 2+ on its own. "Shirley Park BTG" where BTG appears
 ...
 * "Colin Inkyu Kim" and "Hannah Seline Kim" leaked "kim" into the vocabulary
